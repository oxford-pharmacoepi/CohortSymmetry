...
If one wants to generate two drugs cohorts in cdm, DrugUtilisation is recommended. As an example, amiodarone and levothyroxine are used. Famously, this is a known positive benchmark in [Pratt et al.](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4690514/)
