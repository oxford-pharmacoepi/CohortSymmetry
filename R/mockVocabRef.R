...
mockVocabRef <- function(backend = "database") {
  ...
  person <- dplyr::tibble(
    person_id = 1:100,
    gender_concept_id = sample(c(8507, 8532), 100, T),
    year_of_birth = sample(1950:2020, 100, T),
    day_of_birth = sample(1:365, 100, T),
  ...
  drug_exposure = dplyr::tibble(
    ...
    person_id = rep(1,4),
    drug_concept_id = sample(c(1:19), 4, replace = T),
