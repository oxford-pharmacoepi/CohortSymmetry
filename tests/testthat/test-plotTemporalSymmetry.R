test_that("plot working", {
  ...
  plotTS8 <- plotTemporalSymmetry(cdm, "joined_cohort", indexId = c(1))
  plotTS9 <- plotTemporalSymmetry(cdm, "joined_cohort", markerId = c(1,2))
...
test_that("expected errors", {
  ...
  expect_error(plotTemporalSymmetry(cdm, "joined_cohort", indexId = 6))
  expect_error(plotTemporalSymmetry(cdm, "joined_cohort", markerId = c("1", "2")))
