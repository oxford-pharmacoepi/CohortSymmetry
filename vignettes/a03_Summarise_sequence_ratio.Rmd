...
By default, the `summariseSequenceRatio()` function will use 95% (two-sided) confidence interval. If another confidence interval is desired, for example 99% confidence interval, one can use the `confidenceInterval` argument:
```{r message = FALSE, warning = FALSE}
summariseSequenceRatio(
  cohort = cdm$intersect,
