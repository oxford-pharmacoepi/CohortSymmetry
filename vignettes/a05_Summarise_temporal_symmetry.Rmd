...
This parameter is used to subset the cohort table inputted to the `summariseTemporalSymmetry()`. Imagine the user only wants to include `cohort_definition_id` $= 1$ in the `summariseTemporalSymmetry()`, then one could do the following:
