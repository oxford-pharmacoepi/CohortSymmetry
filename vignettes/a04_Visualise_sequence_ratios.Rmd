...
Recall we had the table **intersect** in the cdm reference and that the results of sequence ratio could produced as follows:
...
The function `tableSequenceRatios` inputs the result from `summariseSequenceRatio`, the default outputs a gt table.
